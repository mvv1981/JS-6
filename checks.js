...
// Добавляем новый номер двум контактам
phoneBook('ADD Alex 777-77-77');
phoneBook('ADD Ivan 777-77-77');

// Удаляем телефон
phoneBook('REMOVE_PHONE 777-77-77');

// Проверка удаления одного номера у двух контактов
assert.deepEqual(
    // Получаем содержимое телефонной книги
    phoneBook('SHOW'),
    [
